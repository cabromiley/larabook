            ...
            <div class="flex flex-col h-0 flex-1">
                ...
                <div class="flex-1 flex flex-col overflow-y-auto">
                    <nav class="flex-1 px-2 py-4 bg-gray-800 space-y-1">
                        <a href="{{ route('documentation.index') }}" class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-white rounded-md bg-gray-900 focus:outline-none focus:bg-gray-700 transition ease-in-out duration-150">
                            <!-- Heroicon name: home -->
                        ...
                        @foreach($components as $component)
                            <a href="{{ route('documentation.show', [ 'component' => $component['name'] ]) }}" class="group flex w-full items-center px-2 py-2 text-sm leading-5 font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition ease-in-out duration-150">
                                <!-- Heroicon name: users -->
        ...
        <main class="flex-1 relative overflow-y-auto focus:outline-none" tabindex="0">
            <div class="pt-2 pb-6 md:py-6">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    @isset($currentComponent)
                        <h1 class="text-2xl font-semibold text-gray-900">{{ $currentComponent['name'] ?? 'Dashboard' }}</h1>
                    @else
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div class="py-4">
                            @isset($currentComponent)
                                <x-dynamic-component :component="$currentComponent['name']" />
                            @endisset
                    </div>
                    <!-- /End replace -->
                </div>
